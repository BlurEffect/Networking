...
void SetupTextures()
{
	D3DXCreateTextureFromFile(g_pd3dDevice, "Textures/Background.png", &g_pTexture);
}
...
int WINAPI WinMain( HINSTANCE hInst, HINSTANCE, LPSTR, int)
{
    ...
    HWND hWnd = CreateWindow( "Networking Assignment", "Networking Assignment",
	...
	cout << "\nClient terminated";
    UnregisterClass("Networking Assignment", wc.hInstance);
